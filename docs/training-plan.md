...
> 本文件保留 2026-09-20 的初版設計，供追查實作演進。現行版本使用 87 筆對話（70 筆訓練、17 筆驗證），並已完成 Windows 原生 QLoRA 訓練與本機展示；執行方式以 [README](../README.md)、[開發指南](development.md)及[第二輪訓練報告](../reports/training_round2.md)為準。文中相對程式路徑均以專案根目錄為基準。
...
原稿存放於 [`data/raw/qa/`](../data/raw/qa/README.md) 的五份 `airport_mrt_qa_*.md`。保留 50 題；047、050 等被刪除的題號不再匯入。
